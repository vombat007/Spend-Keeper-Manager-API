...
AUTH_USER_MODEL = 'django_app_api.User'
SOCIAL_AUTH_USER_MODEL = 'django_app_api.User'
...
INSTALLED_APPS = [
    ...
    'django_app_api.apps.DjangoAppApiConfig',
    'rest_framework',
    'drf_spectacular',
...
WSGI_APPLICATION = 'django_spend_keeper.wsgi.application'
